...
// import rsumo from "../assets/rfutboll.png";
// import contest from "../assets/rfutboll.png";
// import fixtirolar from "../assets/rfutboll.png";
...
// import { Link } from "react-router-dom";
// import rfootbol from "../assets/rfutboll.png";
// import rsumo from "../assets/rsumo.png";
// import foydali from "../assets/foydali.png";
// import iaDay from "../assets/aiday.png";
// import contest from "../assets/contesttt.png";
...
// // ========== KOMPONENTLARNI TASHQARIGA CHIQARDIM ==========
...
//         <select
//           value={
//             tumanlarList.find((t) => t.name_uz === form.district)?.id || ""
//           }
//           onChange={onDistrictChange}
//           disabled={!regionId}
//           className={`w-full selectV text-white border border-gray-700 rounded-lg p-2 ${
...
//         }}
//         className={`flex-1 px-4 py-3 rounded-xl transition font-semibold ${
//           loading || !agree ? "btn-disabled" : "btn-enabled"
//         }`}
//       >
//         {loading ? "Tasdiqlanmoqda..." : "Ro'yxatdan o'tish"}
...
//                 <div className="mb-4 p-3 bg-blue-500/20 border border-blue-500/40 rounded-xl">
//                   <p className="text-blue-300 text-sm">
//                     ⚽ Bu yo'nalishda 2 kishilik jamoa kerak.
//                   </p>
//                 </div>
//               )}
//               {noForm && (
...
//                 <p className="text-gray-400 text-sm">
//                   {noForm
//                     ? "Contest uchun ro'yxatdan o'tdingiz!"
//                     : needsPartner
//                     ? "Siz va sherigingiz ro'yxatdan o'tdingiz!"
...
//                 <button
//                   onClick={() => navigate("/")}
//                   className="px-6 py-3 rounded-lg bg-purple-600 hover:bg-purple-500 transition text-white font-semibold shadow-md"
//                 >
//                   Bosh sahifaga
//                 </button>
//               </div>
...
// ========== YO'NALISHGA QARAB RASM TANLASH ==========
const DIRECTION_IMAGES: Record<string, string> = {
  "robo-sumo": iaDay, // /register/robo-sumo → aiday.png
  rsumo: rsumo, // /register/rsumo → rsumo.png
  rfutbol: rfootbol, // /register/rfutbol → rfutboll.png
  fixtirolar: foydali, // /register/fixtirolar → foydali.png
  ixtirolar: foydali, // /register/ixtirolar → foydali.png
  ai: rsumo, // /register/ai → rsumo.png (agar kerak bo'lsa)
  contest: contest, // /register/contest → contesttt.png
};
