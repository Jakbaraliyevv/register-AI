        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 text-sm sm:text-base">
              AI Day (Prompt): So‘zlaringiz Kuchga Aylanadigan Kun! To‘g‘ri
              yozilgan prompt — minglab natijalarga eshik ochadi.
            </p>

            <p className="text-gray-400 mb-10 text-sm sm:text-base mb-6">
              Bu tadbir sizga AI bilan professional darajada “muloqot qilishni”
              o‘rgatadi.
            </p>
